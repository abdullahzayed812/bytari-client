...
export default function BatchDetailsScreen() {
  ...
  const handleDeleteBatch = () => {
    if (mockBatchData.status === "completed") {
      ...
      Alert.alert("حذف الدفعة", "هل أنت متأكد من حذف هذه الدفعة؟ لا يمكن التراجع عن هذا الإجراء.", [
    ...
    <View>
      ...
      <View style={styles.statsGrid}>
        ...
        <View style={styles.statCard}>
          ...
          <Text style={styles.statLabel}>{mockBatchData.status === "completed" ? "العدد الصافي" : "العدد الحالي"}</Text>
        </View>
        ...
        <View style={styles.statCard}>
          ...
          <Text style={styles.statValue}>
            {mockBatchData.status === "completed" && mockBatchData.netProfit
              ? mockBatchData.netProfit.toLocaleString() + " دينار"
              : mockBatchData.weight + " كغ"}
          </Text>
          <Text style={styles.statLabel}>{mockBatchData.status === "completed" ? "الربح الصافي" : "متوسط الوزن"}</Text>
        </View>
      </View>
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={[styles.tabContainer, { flexDirection: isRTL ? "row-reverse" : "row" }]}>
        ...
        >
          <Text style={[styles.tabText, selectedTab === "weekly" && styles.activeTabText]}>السجلات الأسبوعية</Text>
        </TouchableOpacity>
        ...
        >
          <Text style={[styles.tabText, selectedTab === "records" && styles.activeTabText]}>السجلات المفصلة</Text>
        </TouchableOpacity>
      </View>
