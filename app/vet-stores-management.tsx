...
export default function VetStoresManagementScreen() {
  ...
  const renderStoreCard = (store: VetStore) => (
    <View key={store.id} style={styles.storeCard}>
      ...
      <View style={styles.storeSpecialties}>
    ...
    <>
      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>متاجر الأطباء البيطريين</Text>
        ...
        <View style={styles.statsContainer}>
          <View style={styles.statCard}>
            ...
            <Text style={styles.statNumber}>{mockVetStores.length}</Text>
        ...
        <ScrollView style={styles.storesList} showsVerticalScrollIndicator={false}>
          {filteredStores.length > 0 ? (
            ...
            <View style={styles.emptyState}>
              <Store size={48} color={COLORS.lightGray} />
