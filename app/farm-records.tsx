    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={[styles.filterContainer, { flexDirection: isRTL ? "row-reverse" : "row" }]}>
          ...
          >
            <Text style={[styles.filterText, selectedPeriod === "all" && styles.activeFilterText]}>جميع الفترات</Text>
          </TouchableOpacity>
          ...
          >
            <Text style={[styles.filterText, selectedPeriod === "year" && styles.activeFilterText]}>هذا العام</Text>
          </TouchableOpacity>
          ...
          >
            <Text style={[styles.filterText, selectedPeriod === "quarter" && styles.activeFilterText]}>آخر 3 أشهر</Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.section}>
          ...
          {mockCompletedBatches.map((batch) => (
            <TouchableOpacity key={batch.id} style={styles.batchCard} onPress={() => handleViewBatchDetails(batch.id)}>
              <View style={[styles.batchHeader, { flexDirection: isRTL ? "row-reverse" : "row" }]}>
                <View style={styles.batchInfo}>
                  <Text style={[styles.batchNumber, { textAlign: isRTL ? "right" : "left" }]}>{batch.batchNumber}</Text>
                ...
                <View style={styles.batchStats}>
                  ...
                  <View style={styles.statItem}>
                    ...
                    <Text style={[styles.statItemValue, { color: COLORS.success }]}>
                      {batch.netProfit.toLocaleString()} دينار
                    </Text>
                  </View>
                </View>
              </View>
