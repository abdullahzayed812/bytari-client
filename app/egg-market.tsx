...
import { EggMarketCard, EGG_TYPE_LABELS } from "../components/poultry/EggMarketCard";
...
export default function EggMarketScreen() {
  ...
  const { ads, isLoading, refetch, adminDelete } = useEggMarket({
    eggType: selectedType || undefined,
    ...
    <>
      <Stack.Screen
        options={{
          ...
          headerLeft: () => (
            <TouchableOpacity style={styles.addBtn} onPress={() => router.push("/create-egg-market-ad")}>
      ...
      <SafeAreaView style={styles.container} edges={["bottom"]}>
        ...
        {isLoading ? (
          ...
          <View style={styles.empty}>
            ...
            <TouchableOpacity style={styles.emptyBtn} onPress={() => router.push("/create-egg-market-ad")}>
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <EggMarketCard ad={item as any} isAdmin={canModerate} onDelete={() => adminDelete({ adId: item.id })} onPress={() => {}} />
            )}
