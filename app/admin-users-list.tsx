...
const permissionTranslations: Record<string, string> = {
  ...
  manage_poultry_section: "إدارة قسم الدواجن",
  manage_poultry_traders: "إدارة تجار الدواجن",
  manage_poultry_market: "إدارة سوق الدواجن",
  manage_egg_market: "إدارة سوق البيض",
  manage_poultry_exchange: "إدارة بورصة الدواجن",
  manage_egg_exchange: "إدارة بورصة البيض",
