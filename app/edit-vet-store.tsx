...
import { ArrowLeft, Save, Stethoscope } from 'lucide-react-native';
import { COLORS } from "../constants/colors";

export default function EditVetStoreScreen() {
  ...
  const [formData, setFormData] = useState({
    ...
    city: 'بغداد',
    description: 'متجر متخصص في الأدوية والمعدات البيطرية',
    ...
    Alert.alert(
      ...
      [
        ...
        { 
          text: 'حفظ', 
          onPress: () => {
            console.log('Vet store updated:', formData);
            router.back();
          }
        }
      ]
  ...
  return (
    <>
      <Stack.Screen 
        options={{ 
          title: 'تعديل متجر الطبيب البيطري',
      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>تعديل متجر الطبيب البيطري</Text>
