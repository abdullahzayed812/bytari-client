...
export default function StoreOrdersScreen() {
  ...
  // Determine store type from params or user mode
  const storeType =
    (params.storeType as "veterinarian" | "pet_owner") || (userMode === "veterinarian" ? "veterinarian" : "pet_owner");
  ...
  const { data, isLoading, isError, refetch } = useQuery(
    trpc.unifiedStore.listStoreOrders.queryOptions({
      storeType,
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Stack.Screen
        options={{
          title: storeType === "veterinarian" ? "طلبات المتجر البيطري" : "طلبات متجر الحيوانات",
          headerShown: true,
            ...
            <ScrollView style={styles.modalContent}>
              ...
              <View style={styles.section}>
                ...
                <View style={styles.infoRow}>
                  ...
                  <Text style={styles.infoText}>{selectedOrder.shippingAddress?.address || "غير محدد"}</Text>
                </View>
              </View>
