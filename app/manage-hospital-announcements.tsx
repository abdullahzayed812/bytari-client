...
export default function ManageHospitalAnnouncementsScreen() {
  ...
  const handleDeleteAnnouncement = (announcementId: string, title: string) => {
    ...
    Alert.alert("تأكيد الحذف", `هل أنت متأكد من حذف "${title}"؟\n\n⚠️ تحذير: هذا الإجراء لا يمكن التراجع عنه.`, [
    ...
    <SafeAreaView style={styles.container} edges={["top"]}>
      ...
      <View style={styles.content}>
        {!canManage && (
          <View style={styles.accessDeniedContainer}>
            ...
            <View style={styles.accessDeniedContent}>
              ...
              <Text style={styles.accessDeniedNote}>يمكنك عرض الإعلانات فقط ولكن لا يمكنك إدارتها.</Text>
            </View>
          </View>
        )}
        ...
        <View style={styles.hospitalInfo}>
          ...
          <Text style={styles.hospitalInfoText}>إدارة إعلانات: {getHospitalName()}</Text>
        </View>
        ...
        <View style={styles.filterContainer}>
          <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.filterScroll}>
            {[
              ...
              <TouchableOpacity
                key={filter.key}
                style={[styles.filterButton, selectedType === filter.key && styles.activeFilterButton]}
                onPress={() => setSelectedType(filter.key as any)}
              >
                <Text style={[styles.filterButtonText, selectedType === filter.key && styles.activeFilterButtonText]}>
                  {filter.label}
                </Text>
              </TouchableOpacity>
            ))}
        ...
        {canManage && (
          <View style={styles.permissionInfo}>
            ...
            <Text style={styles.permissionInfoText}>لديك صلاحية كاملة لإدارة إعلانات هذا المستشفى</Text>
          </View>
        )}
      </View>
    </SafeAreaView>
