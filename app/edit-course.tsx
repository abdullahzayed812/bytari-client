...
export default function EditCourseScreen() {
  ...
  if (isCourseLoading || !formData) {
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.content}>
          <Text style={{ fontSize: 18, textAlign: "center", marginTop: 40 }}>جاري تحميل بيانات الدورة...</Text>
        </View>
      </SafeAreaView>
    );
  }
    ...
    <>
      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>تعديل الدورة</Text>
        ...
        <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
          ...
          >
            ...
            <Text style={styles.saveButtonText}>{isLoading ? "جاري التحديث..." : "حفظ التغييرات"}</Text>
          </TouchableOpacity>
        </ScrollView>
      </SafeAreaView>
    </>
