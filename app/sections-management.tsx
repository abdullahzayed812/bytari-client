...
export default function SectionsManagementScreen() {
  ...
  const handleHideSection = (sectionId: string) => {
    Alert.alert("إخفاء القسم", "هل تريد إخفاء هذا القسم؟", [
      { text: "إلغاء", style: "cancel" },
      {
        text: "إخفاء",
        onPress: () => {
    ...
    <View style={styles.container}>
      <Stack.Screen
        options={{
          ...
          headerRight: () => (
            <TouchableOpacity onPress={handleAddSection} style={styles.addButton}>
      ...
      <Modal visible={modalVisible} animationType="slide" presentationStyle="pageSheet">
        <View style={styles.modalContainer}>
          <View style={styles.modalHeader}>
            ...
            <Text style={styles.modalTitle}>{editingSection ? "تعديل القسم" : "إضافة قسم جديد"}</Text>
