...
import { ArrowRight, Settings, BarChart3, Users, Bell } from 'lucide-react-native';
import { SafeAreaView } from 'react-native-safe-area-context';

export default function HospitalsSettingsScreen() {
  const router = useRouter();

  const handleSettingPress = (settingId: string) => {
    switch (settingId) {
      case 'general':
        router.push('/hospitals-general-settings');
        break;
      case 'notifications':
        router.push('/hospitals-notifications-settings');
        break;
      case 'users':
        router.push('/hospitals-users-management');
        break;
      case 'analytics':
        router.push('/hospitals-analytics');
        break;
      default:
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>إعدادات المستشفيات</Text>
