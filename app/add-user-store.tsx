    ...
    <>
      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>{t("addUserStore.title")}</Text>
        ...
        <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
          <View style={styles.formSection}>
            <View style={styles.sectionHeader}>
              ...
              <Text style={styles.sectionTitle}>{t("addUserStore.storeInfo")}</Text>
            </View>
            ...
            <View style={styles.inputGroup}>
              ...
              <TextInput
                ...
                placeholder={t("addUserStore.enterStoreName")}
                placeholderTextColor={COLORS.darkGray}
              />
            </View>

            <View style={styles.inputGroup}>
              <Text style={styles.label}>{t("addUserStore.ownerName")}</Text>
              <TextInput
                style={styles.input}
                value={formData.ownerName}
                onChangeText={(value) => updateField("ownerName", value)}
                placeholder={t("addUserStore.enterOwnerName")}
                placeholderTextColor={COLORS.darkGray}
              />
            </View>
            ...
            <View style={styles.inputGroup}>
              ...
              <TextInput
                ...
                placeholder={t("addUserStore.enterStoreDesc")}
                placeholderTextColor={COLORS.darkGray}
                multiline
                numberOfLines={4}
        ...
        <View style={styles.bottomActions}>
          <TouchableOpacity style={styles.createButton} onPress={handleCreate}>
            ...
            <Text style={styles.createButtonText}>{t("addUserStore.createStore")}</Text>
          </TouchableOpacity>
        </View>
      </SafeAreaView>
    </>
