...
import { ArrowRight, Settings, Bell, Users, BarChart3 } from "lucide-react-native";
    ...
    <SafeAreaView style={styles.container} edges={["top"]}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        {settingsOptions.map((option) => {
          ...
          return (
            <TouchableOpacity key={option.id} style={styles.settingCard} onPress={() => handleSettingPress(option.id)}>
