...
import { ArrowLeft, MessageCircle, AlertCircle, CheckCircle, Clock } from "lucide-react-native";
...
export default function MessagesScreen() {
  ...
  const markAsRead = (messageId: number) => {
    ...
    markAsReadMutation.mutate(
      { userId: user.id, messageId: messageId },
      {
        onSuccess: () => {
            ...
            <View style={[styles.messageContent, { flexDirection: isRTL ? "row-reverse" : "row" }]}>
              ...
              >
                <View style={[styles.messageHeader, { flexDirection: isRTL ? "row-reverse" : "row" }]}>
                  <Text style={[styles.senderName, { textAlign: isRTL ? "left" : "right" }]}>System</Text>
