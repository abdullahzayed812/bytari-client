    ...
    <View style={styles.container}>
      ...
      <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.gallery}>
        ...
        {images.length < maxImages && (
          <TouchableOpacity style={styles.addButton} onPress={handleAddImage} disabled={isLoading}>
      ...
      {images.length === 0 && <Text style={styles.emptyText}>لم يتم إضافة صور بعد</Text>}
    </View>
  );
}
